...
#import
#define _LOGIN_ACCOUNT_VERSION_ 1.0
...
public:
   ...
   bool              Login(string _accountNumber, string _accountPassword, string _serverHostname)
     {
      if(loginDialogIsOpen())
         closeLoginDialog();

      if(auth(_accountNumber, _accountPassword, _serverHostname))
        {
         return true;
        }
      else
   ...
   //-------------------------------------------------------------------------------------------------|
   //DO NOT MODIFY OR TOUCH ANYTHING UNDER THIS LINE
   //-------------------------------------------------------------------------------------------------|
